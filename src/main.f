...
c     Standard Fortran versions of functions used, guesswork            TTT
      Real Function TIMEF(i)                                            TTT
        ...
        Integer:: i                                                     TTT
        timef=0.0                                                       TTT
c       Write(error_unit,FMT=*) "TTT TIMEF(",i,")",TIMEF                TTT
      End Function                                                      TTT
      Subroutine RANFSET(x)                                             TTT
        Use iso_fortran_env, Only:error_unit                            TTT
        Real :: x                                                       TTT
c       Write(error_unit,FMT=*) "TTT RANFSET(",x,")"                    TTT
        Return                                                          TTT
      End Subroutine                                                    TTT
      Real Function ABSF(x)                                             TTT
        ...
        Real :: x                                                       TTT
        ABSF=Abs(x)                                                     TTT
c       Write(error_unit,FMT=*) "TTT ABSF(",x,")",ABSF                  TTT
      End Function                                                      TTT
      Real Function EXPF(x)                                             TTT
        Use iso_fortran_env, Only:error_unit                            TTT
        Real :: x                                                       TTT
        EXPF=Exp(x)                                                     TTT
c       Write(error_unit,FMT=*) "TTT EXPF(",x,")",EXPF                  TTT
      End Function                                                      TTT
      Real Function LOGF(x)                                             TTT
        Use iso_fortran_env, Only:error_unit                            TTT
        Real :: x                                                       TTT
        LOGF=Log(x)                                                     TTT
c       Write(error_unit,FMT=*) "TTT LOGF(",x,")",LOGF                  TTT
      End Function                                                      TTT
      Real Function SQRTF(x)                                            TTT
        Use iso_fortran_env, Only:error_unit                            TTT
        Real :: x                                                       TTT
        SQRTF=Sqrt(x)                                                   TTT
c       Write(error_unit,FMT=*) "TTT SQRTF(",x,")",SQRTF                TTT
      End Function                                                      TTT
      Real Function FLOATF(i)                                           TTT
        Use iso_fortran_env, Only:error_unit                            TTT
        Integer :: i                                                    TTT
        FLOATF=Real(i)                                                  TTT
c       Write(error_unit,FMT=*) "TTT FLOATF(",i,")",FLOATF              TTT
      End Function                                                      TTT
      Integer Function XINTF(x)                                         TTT
        Use iso_fortran_env, Only:error_unit                            TTT
        Real :: x                                                       TTT
        XINTF=Sign(1.0,x)*Floor(Abs(x))                                 TTT
c       Write(error_unit,FMT=*) "TTT XINTF(",x,")",XINTF                TTT
      End Function                                                      TTT
      Real Function INTF(x)                                             TTT
        Use iso_fortran_env, Only:error_unit                            TTT
        Real :: x                                                       TTT
        INTF=Sign(1.0,x)*Floor(Abs(x))                                  TTT
c       Write(error_unit,FMT=*) "TTT INTF(",x,")",INTF                  TTT
      End Function                                                      TTT
      Real Function RANF(i)                                             TTT
        Use iso_fortran_env, Only:error_unit                            TTT
        Integer :: i                                                    TTT
        Call Random_Number(ranf)                                        TTT
c       Write(error_unit,FMT=*) "TTT RANF(",i,")",RANF                  TTT
      End Function                                                      TTT
...
c       Write(error_unit,FMT=*) "TTT XRANF(",i,")",XRANF                TTT
      End Function                                                      TTT
      Subroutine EXIT()                                                 TTT
        Use iso_fortran_env, Only:error_unit                            TTT
c       Write(error_unit,FMT=*) "TTT EXIT"                              TTT
        Stop                                                            TTT
      End Subroutine                                                    TTT
